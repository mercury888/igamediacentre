...
class CacheDbSettings {
	...
	public function register_settings() {
		...
		if ( function_exists( 'rest_get_server' ) ) {
			...
			$this->update( 'namespaces', self::get_rest_api_namespaces() );
		}
		$this->update( 'sanitized_post_types', self::get_sanitized_post_types() );
		$this->update( 'sanitized_builtin_post_types', self::get_sanitized_post_types( true ) );
	}
